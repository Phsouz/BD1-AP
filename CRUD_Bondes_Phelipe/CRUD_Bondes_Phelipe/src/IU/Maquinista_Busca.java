 ...
 */
public class Maquinista_Busca extends javax.swing.JDialog {
    
    Circuito circuito;
    
    public Maquinista_Busca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         try {
            fillCBPais();
    ...
    private void jTableCircuitosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableCircuitosMouseClicked
        String nomeCircuito = jTableCircuitos.getValueAt(jTableCircuitos.getSelectedRow(), 0).toString();
        CircuitoDAO dao = new CircuitoDAO();
        try {
            this.circuito = dao.find(nomeCircuito);
    ...
    private void loadRecords() throws SQLException {
        String sql = "SELECT nome AS Nome, pais_sigla AS 'Sigla do Pais', cidade AS Cidade, status AS Status FROM CIRCUITO WHERE status = true";
        ...
        jTableCircuitos.setModel(tableModel);
         ...
         //Adjusting columns 
        jTableCircuitos.getColumnModel().getColumn(0).setMaxWidth(260); //nome
        jTableCircuitos.getColumnModel().getColumn(1).setMaxWidth(50);// pais_sigla
        jTableCircuitos.getColumnModel().getColumn(2).setMaxWidth(150); //"sigla"
        jTableCircuitos.getColumnModel().getColumn(3).setMaxWidth(40); //"status"

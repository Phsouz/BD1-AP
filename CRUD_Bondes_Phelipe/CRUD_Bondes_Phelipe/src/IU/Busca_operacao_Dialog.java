...
import DAO.bonde_operacaoDAO;
import DAO.maquinistaDAO;
 ...
 */
public class Busca_operacao_Dialog extends javax.swing.JDialog {

    public Busca_operacao_Dialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        try {
            loadRecords();
